...
public class NavigationDrawerFragment extends Fragment implements View.OnClickListener, NavUpdateListener {
    ...
    Sessionwa sessionwa;
    private Button homeBtn, settingsBtn, share_btn, logoutBtn, historyBtn, earningsBtn,kyc_update, summaryBtn, helpBtn;
    ...
    private void setBtnDrawables() {
        ...
        img.setBounds(0, 0, 35, 35);
        img.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorPrimaryDark), PorterDuff.Mode.SRC_ATOP);
        kyc_update.setCompoundDrawables(img, null, null, null);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        findViewsById(view);
        sessionwa = new Sessionwa(getActivity());
        setClickListeners();
        setBasicDetails();
    ...
    private void findViewsById(View view) {
        ...
        kyc_update = (Button) view.findViewById(R.id.settings_kyc_update);
    ...
    private void setClickListeners() {
        ...
        kyc_update.setOnClickListener(this);
    }
...
//            setBtnStates(share_btn);
        ...
        else if (v == kyc_update) {
            setBtnStates(settingsBtn);
            mNavMenuItems = NavMenu.Kyc_Update;
        }
    ...
    private void setBtnStates(Button button) {
        ...
        kyc_update.setSelected(button == kyc_update);
    }
