...
import com.xuber_for_services.provider.KYC_Activity.Kyc1_Activity;
import com.xuber_for_services.provider.KYC_Activity.Kyc2_Activity;
import com.xuber_for_services.provider.KYC_Activity.KycActivity;
...
public class Home extends AppCompatActivity implements NavigationDrawerFragment.NavDrawerFgmtListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionwa=new Sessionwa(Home.this);
    ...
    public void menuClicked(NavMenu navMenu) {
        ...
        switch (navMenu) {
            ...
            case Kyc_Update:
                ...
                startActivity(new Intent(context, Kyc1_Activity.class));
                SharedHelper.putKey(Home.this,"kyc_update","kyc");
                break;
