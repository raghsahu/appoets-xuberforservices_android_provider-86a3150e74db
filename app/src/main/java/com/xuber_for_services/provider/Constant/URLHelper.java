...
//    public static final String BASE_URL = "http://ihisaab.in/toolplus/public";
    ...
    public static final String Otp = BASE_URL + "/api/provider/register/verifyOtp";
    ...
    public static final String IMG_PROFILE = BASE_URL + "/api/provider/kyc_register_form";
    public static final String IMG_PROFILE_UPDATE = BASE_URL + "/api/provider/kyc_update";
