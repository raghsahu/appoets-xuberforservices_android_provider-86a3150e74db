...
public class Utilities_Multipart {
...
//            BufferedReader reader = new BufferedReader(new InputStreamReader(is, "iso-8859-1"), 8);
    ...
    public static String postEntityAndFindJson(String url, MultipartEntity params, String heder) {
        JSONObject jObj = new JSONObject();
        String result = "";

        System.out.println("URL comes in jsonparser class is:  " + url + params);
        System.out.println("Authorization"+ "Bearer"+" "+heder);
        try {
            int TIMEOUT_MILLISEC = 10000; // = 10 seconds
            HttpParams httpParams = new BasicHttpParams();
            HttpConnectionParams.setConnectionTimeout(httpParams, TIMEOUT_MILLISEC);
            ...
            httpPost.addHeader("Authorization", "Bearer" + " " + heder);
            httpPost.setHeader("Authorization", "Bearer" + " " + heder);
